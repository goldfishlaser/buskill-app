...
${PYTHON_PATH} -m pip list
HOMEBREW_NO_INSTALLED_DEPENDENTS_CHECK=1 ${BREW} install --debug --verbose --ignore-dependencies --skip-cask-deps build/deps/virtualenv-20-25.1.ventura.bottle.tar.gz
