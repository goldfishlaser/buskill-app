...
${BREW} reinstall --debug --verbose --ignore-dependencies --force-bottle build/deps/python-3.12.ventura.bottle.tar.gz
...
${BREW} reinstall --debug --verbose --ignore-dependencies --force-bottle build/deps/virtualenv-20-25.1.ventura.bottle.tar.gz
